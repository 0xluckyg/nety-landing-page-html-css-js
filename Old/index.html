                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="#features">privacy policy</a>
                            </li>
                            <li><a href="#features">terms of service</a>
                            </li>
                ...
                <ul>
                    <!-- SLIDE  -->
                     <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                        ...
                        data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;"
                            ...
                            <img src="assets/img/freeze/Slides/family-freeze.png" style="width:45%;" alt="">
                        </div>
                        ...
                        <div class="tp-caption mediumlarge_light_white sfl hidden-xs" data-x="80" data-y="320" data-hoffset="0" data-voffset="-50" data-speed="1000" data-start="1000" data-easing="Power4.easeOut">
                           <p class="slide1">SEARCH FOR NEW <br>CONNECTIONS NEAR YOU</p>                           
                        </div>                        
                    ...
                    <li data-transition="fade" data-slotamount="7" data-masterspeed="1000" >
                        ...
                        <div class="tp-caption lfl fadeout hidden-xs"
                            ...
                            data-start="700"
                            data-easing="Power4.easeOut">
                            <img src="assets/img/freeze/Slides/hand-freeze.png" style="width: 53%;" alt="">
                        </div>
                        ...
                        <div class="tp-caption large_white_light sfb" data-x="500" data-y="center" data-hoffset="0" data-voffset="0" data-speed="1000" data-start="1500" data-easing="Power4.easeOut">
                            FIND YOUR MATCH
                        </div>
                    ...
                    <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                        ...
                        <div class="tp-caption lfb fadeout hidden-xs"
                            ...
                            data-start="700"
                            data-easing="Power4.easeOut">
                            <img src="assets/img/freeze/Slides/freeze-slide2.png" style="width: 40%;" alt="">
                        </div>
        ...
        <section id="about">
            <div class="container">
                ...
                <div class="section-heading scrollpoint sp-effect3">
                    ...
                    <p>BE IN CONTROL OF WHERE YOU ARE AND WHO YOU MEET</p>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-6">
                        <div class="about-item scrollpoint sp-effect2">
                            ...
                            <p>You can browse and connect with people in areas ranging from the event you're at to the city you live in. Never miss an opportunity.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect5">
                            <i class="fa  fa-user fa-2x"></i>
                            <h3>FULLY CUSTOMIZABLE PROFILE</h3>
                            <p>Show off yourself by customizing experiences, summary, and status of what kind of people you are looking for.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4 col-xs-6" >
                        <div class="about-item scrollpoint sp-effect5">
                            ...
                            <h3>FULLY SECURE</h3>
                            <p>We are professional and creeper-free. You can customize who can talk to you and where you can be discovered.</p>
                        </div>
                    </div>
                            ...
                            <a href="#" class="btn btn-primary inverse scrollpoint sp-effect1">
                                ...
                                <a href="#" class="btn btn-primary inverse scrollpoint sp-effect2">
                                    ...
                                    <b>Apple IOS</b>
                                            ...
                                            <div class="hanging-phone scrollpoint sp-effect2 hidden-xsa">
                            <img src="assets/img/freeze/freeze-angled2.png" class="hanging-phone-image" alt="">
                        </div>
                </div>
        ...
        <section id="support" class="doublediagonal">
            <div class="container">
                <div class="section-heading scrollpoint sp-effect3">
                    <h1>SUPPORT</h1>
                    <div class="divider"></div>
                    <p>HAVE A FEEDBACK OR LOOKING A PARTNERSHIP?</p>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            //if "email" variable is filled out, send email
                              ...
                              //Email information
                              $admin_email = "appnety@gmail.com";
                              $userName = $_REQUEST['userName'];
                              $email = $_REQUEST['email'];
                              $message = $_REQUEST['message'];                            
                                
                              //send email
                              mail($admin_email, "$userName", $message);
                            ...
                            <div class="col-md-4 col-sm-4 contact-details scrollpoint sp-effect2">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading">West 4th Street, NY, NY</h4>
                                    </div>
                                </div>
                                <div class="media">
                                    <a class="pull-left" href="#" >
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading">
                                            <a href="mailto:support@oleose.com">appnety@gmail.com</a>
                                        </h4>
                                    </div>
                                </div>
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading">+1 347 2766477</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <footer>
            <div class="container">
                ...
                <div class="rights">
                    ...
                    <p>Company by <a href="http://www.scoopthemes.com" target="_blank">NETY, LLC</a></p>
                </div>
            </div>
        </footer>
